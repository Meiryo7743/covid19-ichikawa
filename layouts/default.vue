<template>
  <v-app class="app">
    <v-overlay v-if="loading" color="#F8F9FA" opacity="1" z-index="9999">
      <div class="loader">
        <img src="/logo.png" alt="【非公式】市川市" />
        <scale-loader color="#5ec4f4" />
      </div>
    </v-overlay>
  ...
  head(): MetaInfo {
    ...
    return {
      ...
      link: [
        {
          rel: 'canonical',
          href: `https://stopcovid19-ichikawa.netlify.app${this.$route.path}`
        },
        {
          rel: 'stylesheet',
      ...
      titleTemplate: `%s | ${this.$t('【非公式】市川市')} ${this.$t('新型コロナウイルス感染症')}${this.$t('対策サイト')}`,
      meta: [
        {
          hid: 'description',
          name: 'description',
        ...
        },
        {
          hid: 'og:url',
          property: 'og:url',
          content: `https://stopcovid19-ichikawa.netlify.app${this.$route.path}`
        },
        ogLocale,
        {
          hid: 'og:title',
